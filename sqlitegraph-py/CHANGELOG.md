...
- Bundled core crate is now **sqlitegraph 3.4.3** — brings weighted neighbor retrieval, bulk weighted edge insertion, experimental CSR sharding, and key bug fixes.
