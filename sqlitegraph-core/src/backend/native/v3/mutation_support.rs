...
impl V3Backend {
    ...
    pub(super) fn persist_inserted_node_properties(
        &self,
        node_id: i64,
        kind: &str,
        name: &str,
    ...
    pub(super) fn persist_inserted_edge_attributes(
        &self,
        from: i64,
        to: i64,
        edge_type: &str,
    ...
    pub(super) fn persist_updated_node_properties(
        &self,
        node_id: i64,
        kind: &str,
        name: &str,
    ...
    pub(super) fn persist_deleted_node_marker(
        &self,
        node_id: i64,
        next_version: u64,
    ) -> Result<(), SqliteGraphError> {
