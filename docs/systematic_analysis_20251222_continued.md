...
warning: function `create_test_node_record` is never used
   --> sqlitegraph/src/backend/native/v2/wal/bulk_ingest_tests.rs:286:4
    |
286 | fn create_test_node_record(node_id: i64) -> V2WALRecord {
    |    ^^^^^^^^^^^^^^^^^^^^^^^

warning: function `create_test_cluster_record` is never used
   --> sqlitegraph/src/backend/native/v2/wal/bulk_ingest_tests.rs:295:4
    |
295 | fn create_test_cluster_record(node_id: i64) -> V2WALRecord {
    |    ^^^^^^^^^^^^^^^^^^^^^^^^^^
...
warning: comparison is useless due to type limits
   --> sqlitegraph/src/hnsw/multilayer.rs:803:17
    |
803 |         assert!(level1 >= 0);
    |                 ^^^^^^^^^^^

warning: `sqlitegraph` (lib test) generated 235 warnings (run `cargo fix --lib -p sqlitegraph --tests` to apply 77 suggestions)
