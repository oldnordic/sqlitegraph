...
error[E0425]: cannot find value `lsn` in this scope
  --> sqlitegraph/src/backend/native/v2/wal/checkpoint/record/integrator.rs:77:97
   |
68 |         _lsn: u64,
   |         ---- `_lsn` defined here
...
77 |                 self.apply_node_insert((*node_id).try_into().unwrap(), *slot_offset, node_data, lsn)
   |                                                                                                 ^^^
   |
help: the leading underscore in `_lsn` marks it as unused, consider renaming it to `lsn`
   |
68 -         _lsn: u64,
68 +         lsn: u64,
   |
...
error[E0425]: cannot find value `lsn` in this scope
  --> sqlitegraph/src/backend/native/v2/wal/checkpoint/record/integrator.rs:86:96
   |
68 |         _lsn: u64,
   |         ---- `_lsn` defined here
...
86 |                 self.apply_node_update((*node_id).try_into().unwrap(), *slot_offset, new_data, lsn)
   |                                                                                                ^^^
   |
help: the leading underscore in `_lsn` marks it as unused, consider renaming it to `lsn`
   |
...
error[E0425]: cannot find value `lsn` in this scope
  --> sqlitegraph/src/backend/native/v2/wal/checkpoint/record/integrator.rs:93:87
   |
68 |         _lsn: u64,
   |         ---- `_lsn` defined here
...
93 |             } => self.apply_node_delete((*node_id).try_into().unwrap(), *slot_offset, lsn),
   |                                                                                       ^^^
   |
help: the leading underscore in `_lsn` marks it as unused, consider renaming it to `lsn`
   |
...
error[E0425]: cannot find value `lsn` in this scope
   --> sqlitegraph/src/backend/native/v2/wal/checkpoint/record/integrator.rs:105:21
    |
 68 |         _lsn: u64,
    |         ---- `_lsn` defined here
...
...
error[E0425]: cannot find value `lsn` in this scope
   --> sqlitegraph/src/backend/native/v2/wal/checkpoint/record/integrator.rs:119:21
    |
 68 |         _lsn: u64,
    |         ---- `_lsn` defined here
...
...
error[E0425]: cannot find value `lsn` in this scope
   --> sqlitegraph/src/backend/native/v2/wal/checkpoint/record/integrator.rs:131:21
    |
 68 |         _lsn: u64,
    |         ---- `_lsn` defined here
...
...
error[E0425]: cannot find value `lsn` in this scope
   --> sqlitegraph/src/backend/native/v2/wal/checkpoint/record/integrator.rs:149:21
    |
 68 |         _lsn: u64,
    |         ---- `_lsn` defined here
...
...
error[E0425]: cannot find value `lsn` in this scope
   --> sqlitegraph/src/backend/native/v2/wal/checkpoint/record/integrator.rs:157:69
    |
 68 |         _lsn: u64,
    |         ---- `_lsn` defined here
...
157 |             } => self.apply_string_insert(*string_id, string_value, lsn),
    |                                                                     ^^^
    |
help: the leading underscore in `_lsn` marks it as unused, consider renaming it to `lsn`
    |
...
error[E0425]: cannot find value `lsn` in this scope
   --> sqlitegraph/src/backend/native/v2/wal/checkpoint/record/integrator.rs:164:77
    |
 68 |         _lsn: u64,
    |         ---- `_lsn` defined here
...
164 |             } => self.apply_free_space_allocate(*block_offset, *block_size, lsn),
    |                                                                             ^^^
    |
help: the leading underscore in `_lsn` marks it as unused, consider renaming it to `lsn`
    |
...
warning: `sqlitegraph` (lib test) generated 175 warnings
error: could not compile `sqlitegraph` (lib test) due to 9 previous errors; 175 warnings emitted
